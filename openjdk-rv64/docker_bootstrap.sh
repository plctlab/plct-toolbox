...
./configure --target-list=riscv64-softmmu,riscv64-linux-user --prefix="$QEMUHOME"
make -j $(nproc) && make install

$QEMUHOME/bin/qemu-system-riscv64 --version

#. manual_install_deps.sh
#. build_ext_libs_64.sh
#. build_jdk.sh
